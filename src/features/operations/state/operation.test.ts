...
import { OperationType, StatusType, WrapOperation } from './types';
import BigNumber from 'bignumber.js';

const aNewOperation = () => {
  const newOp: WrapOperation = {
...
const waitingForConfirmation = (newOp: WrapOperation): WrapOperation => ({
  ...newOp,
  status: {
