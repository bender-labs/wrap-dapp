import {Grid, makeStyles, Paper, StepContent, Tab, Tabs, Typography} from "@material-ui/core";
    ...
    <Paper className={classes.swapContainer}>
      <Grid container spacing={3}>
        ...
        <Grid container item xs={12}>
          <Grid item xs={6}>
            <AmountToWrapInput balance={new BigNumber(0)} decimals={18} symbol={token} onChange={setAmountToWrap}
                               amountToWrap={amountToWrap}/>
          </Grid>
          <Grid item xs={6}>
            <TokenSelection token={token} onTokenSelect={setToken} tokens={fungibleTokens}
